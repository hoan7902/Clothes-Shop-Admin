...
const LocationBanner = (): JSX.Element => {
  return (
    <Stack className={styles.background}>
      ...
      <Stack p="30px 0" sx={{ flexDirection: { xs: "column", md: "row" } }} justifyContent="space-around">
        <Stack>
          <Typography className={styles.title}>Lép Hà nội</Typography>
          <Typography className={styles.address}>- 244 Bà Triệu | 0398 841 816</Typography>
          <Typography className={styles.address}>- 244 Bà Triệu | 0398 841 816</Typography>
          <Typography className={styles.address}>- 244 Bà Triệu | 0398 841 816</Typography>
          <Typography className={styles.address}>- 244 Bà Triệu | 0398 841 816</Typography>
          <Typography className={styles.address}>- 244 Bà Triệu | 0398 841 816</Typography>
        ...
        <Stack>
          <Typography className={styles.title}>Lép Các tỉnh thành khác</Typography>
          <Typography className={styles.address}>- 244 Bà Triệu | 0398 841 816</Typography>
          <Typography className={styles.address}>- 244 Bà Triệu | 0398 841 816</Typography>
          <Typography className={styles.address}>- 244 Bà Triệu | 0398 841 816</Typography>
          <Typography className={styles.address}>- 244 Bà Triệu | 0398 841 816</Typography>
